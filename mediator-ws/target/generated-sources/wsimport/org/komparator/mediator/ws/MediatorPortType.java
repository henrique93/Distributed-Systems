...
public interface MediatorPortType {
    ...
    @Action(input = "http://ws.mediator.komparator.org/Mediator/imAlive")
    public void imAlive();
    ...
    @Action(input = "http://ws.mediator.komparator.org/Mediator/updateShopHistory")
    public void updateShopHistory(
        @WebParam(name = "shopResult", targetNamespace = "")
        ShoppingResultView shopResult);
    ...
    @Action(input = "http://ws.mediator.komparator.org/Mediator/updateCart")
